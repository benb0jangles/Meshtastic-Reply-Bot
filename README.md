...
5. **Connect your Meshtastic node**:
...
The bot will:
1. Ask if you want to use the default "ok" reply (or customize it)
2. Prompt you to select a connection type
3. Connect to your Meshtastic node
4. Start monitoring for direct messages
...
1. **Listens for messages**: The bot monitors your Meshtastic node for incoming messages
2. **Filters direct messages**: Only responds to direct messages (not broadcasts)
3. **Auto-reply**: Sends "ok" (or your custom message) back to the sender
4. **Logging**: All activity is logged to console and `logs/` directory
